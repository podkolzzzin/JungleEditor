...
<template>
  <div class="activity-bar">
    <div class="top-icons">
      ...
      <button
        class="ab-btn"
        :class="{ active: active === 'explorer' && sidebarOpen }"
